...
public: //! @name Selection management
  ...
  Standard_EXPORT void RectSelectInit();

  //! Adds new detected entities into the picked list of canditates for selection in addition to the already selected.
  Standard_EXPORT AIS_StatusOfPick RectSelectAdd(const Standard_Integer  theXPMin,
												 const Standard_Integer  theYPMin,
												 const Standard_Integer  theXPMax,
												 const Standard_Integer  theYPMax,
												 const Handle(V3d_View)& theView,
  ...
  Standard_EXPORT AIS_StatusOfPick RectSelectRemove(const Standard_Integer  theXPMin,
													const Standard_Integer  theYPMin,
													const Standard_Integer  theXPMax,
													const Standard_Integer  theYPMax,
													const Handle(V3d_View)& theView,
  ...
  Standard_EXPORT void RectSelectFinish();
...
protected: //! @name internal fields
  ...
  Standard_Boolean myIsRectSelectActive;
};
